...
@section('content')
    <main id="category-list-content">
        ...
        <div class="wrapper">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-base-color">Add Vendor</h4>
                    <form action="{{url('api/v1/vendors')}}" id="form" name="form" enctype="multipart/form-data"
                          novalidate>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade py-3" id="nav-profile" role="tabpanel"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="store_owner" name="store_owner" class="form-control"
