...
@section('content')
    <main id="brands-list-content">
        <div class="wrapper">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-base-color">All Brands</h4>
...
@push('custom-js')
    ...
    <script>
        ...
        $('body').on('click', '.editItem', function () {
            var id = $(this).data('id');
            window.location.href = "{{url('admin/brands/edit')}}" + "/" + id;
        });
        ///Delete Call
        ///Delete Call
        $('body').on('click', '.deleteItem', function () {
            var id = $(this).data("id");
            url = "{{url('api/v1/brands')}}" + "/" + id;
            deleteItem(url)
        });
        ///approval  Call
        ///approval Call
        $(document).on('change', '#approval', function () {
            ...
            url = "{{url('api/v1/manage-brands-approval')}}"
