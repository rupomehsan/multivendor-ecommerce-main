...
@section('content')
    <main id="category-list-content">
        ...
        <div class="wrapper">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-uppercase text-base-color">Slider</h4>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-2 col-sm-2 col-12">
                            <button class="btn btn-base btn-base-primary" data-bs-target="#sliderModal" data-bs-toggle="modal">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header border-0">
                                        <h5 class="modal-title text-uppercase">ADD slider</h5>
                                    </div>
                        ...
                        <div class="col-lg-12 col-sm-12 col-12">
                            <table class="table table-striped" id="category-table">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 400px">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Senectus dictumst et non id a.</td>
                                    <td>60%</td>
                                    <td>
                                        <label class="switch">
                                            <input type="checkbox">
