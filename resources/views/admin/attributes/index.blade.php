...
@section('content')
    <main id="category-list-content">
        <div class="wrapper">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-base-color">Attribute</h4>
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-12 col-sm-12 col-12">
                            <a href="{{url('admin/attributes/create')}}"
...
@push('custom-js')
    ...
    <script>
        ...
        $('body').on('click', '.editItem', function () {
            var id = $(this).data('id');
            window.location.href = "{{url('admin/attributes/edit')}}" + "/" + id;
        });
        ///Delete Call
        ///Delete Call
        ...
        $(document).on('change', '#approval', function () {
            ...
            url = "{{url('api/v1/manage-attributes-approval')}}"
