...
@section('content')
    <main id="category-list-content">
        <div class="wrapper">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-base-color">All Customers</h4>
...
@push('custom-js')
    ...
    <script>
        ...
        $('body').on('click', '.editItem', function () {
            var id = $(this).data('id');
            window.location.href = "{{url('admin/customers/edit')}}" + "/" + id;
        });
        ///Delete Call
        ///Delete Call
        ...
        $(document).on('change', '#approval', function () {
            ...
            url = "{{url('api/v1/manage-customers-approval')}}"
